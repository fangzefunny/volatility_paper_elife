...
def trial_step(
            # 从数据输入值
            info_A_tm1,info_A_t, #Ot-1, Ot (0 or 1) 
            obs_choice_tm1,obs_choice_t,#Ct-1, Ct (0 or 1)
            mag_1_t,mag_0_t,#M1,M2 (0 or 1)
            stabvol_t,rewpain_t,# X(volatile-stable)(0 or 1), X(reward-aversive)(0 or 1)
            #从上一个试次的输出输入的值 
            choice_tm1,#Ct-1
            outcome_valence_tm1, #X(good-bad)(0 or 1)
            prob_choice_tm1, #P(Ct-1=1)
            choice_val_tm1, #P(Ct-1=1)的一部分
            estimate_tm1, #pt-1
            choice_kernel_tm1,#kt-1
            lr_tm1,lr_c_tm1,Amix_tm1,Binv_tm1,Bc_tm1,mdiff_tm1,eps_tm1,# α，η，λ，ω，ωk，(M1-M2)t-1，ε 最优模型中不需要在trial间学习，但是作者加上了
            # 模型参数
            lr_baseline,lr_goodbad,lr_stabvol,lr_rewpain, 
            lr_goodbad_stabvol,lr_rewpain_goodbad,lr_rewpain_stabvol,
            lr_rewpain_goodbad_stabvol,#α

            lr_c_baseline,lr_c_goodbad,lr_c_stabvol,lr_c_rewpain, 
            lr_c_goodbad_stabvol,lr_c_rewpain_goodbad,lr_c_rewpain_stabvol,
            lr_c_rewpain_goodbad_stabvol,#η

            Amix_baseline,Amix_goodbad,Amix_stabvol,Amix_rewpain,
            Amix_goodbad_stabvol,Amix_rewpain_goodbad,Amix_rewpain_stabvol,
            Amix_rewpain_goodbad_stabvol,#λ

            Binv_baseline,Binv_goodbad,Binv_stabvol,Binv_rewpain,
            Binv_goodbad_stabvol,Binv_rewpain_goodbad,Binv_rewpain_stabvol,
            Binv_rewpain_goodbad_stabvol,#ω

            Bc_baseline,Bc_goodbad,Bc_stabvol,Bc_rewpain,
            Bc_goodbad_stabvol,Bc_rewpain_goodbad,Bc_rewpain_stabvol,
            Bc_rewpain_goodbad_stabvol,#ωk
            mag_baseline,mag_rewpain,#r
            eps_baseline,eps_stabvol,eps_rewpain,eps_rewpain_stabvol,#ε
